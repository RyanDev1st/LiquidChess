...
The following will list each section of the landingpage and the corresponding component design files to be used for each section. I want the page to be section-snap, akin to slides. So each section will take up the entire viewport and the user can scroll down to the next section, or scroll back up to the previous section.
...
-Use the component design\desktop-web\components\testimonial\testimonial.md
...
This is what I made. It is vanilla and not good enough yet. 