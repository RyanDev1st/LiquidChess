This section will have 2 components: 
...
https://21st.dev/community/components/shadcnblockscom/logos3/default


# 2. Voice cards

Use this component from 21st.dev
...
https://21st.dev/community/components/misbahansar/expand-cards/default

Keep the images the same, I will replace them with my own assets later. The component and its functionality is what matters for now.

Highlight only the active components. 
