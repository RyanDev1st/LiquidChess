...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[--gold] text-black hover:bg-[--gold-light] shadow-[0_0_20px_rgba(201,168,76,0.3)] hover:shadow-[0_0_30px_rgba(201,168,76,0.5)]",
        outline:
          "border border-white/20 bg-transparent hover:bg-white/8 text-white backdrop-blur-sm",
        ghost: "hover:bg-white/8 text-white/80 hover:text-white",
        glass:
          "glass text-white hover:border-white/20 hover:bg-white/8",
